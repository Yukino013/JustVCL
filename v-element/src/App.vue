...
<template>
  ...
  <main>   
    ...
    <Button type="danger" circle>Danger</Button><br/><br/>
    <!-- 禁用+类型 -->
  ...
  <!-- size + loading/icon  -->
    ...
    <Collapse v-model="openedValue">
      <Item name="a" title="第一个面板">
        <h1>第一个面板标题</h1>
        <div>第一个面板内容</div>
      </Item>
      <Item name="b" title="第二个面板">
        <div>第二个面板内容</div>
      </Item>
      <Item name="c" title="第三个面板" disabled>
        <div>第三个面板内容</div>
      </Item>
    </Collapse>
    ...
    <Icon icon="check" :size="size" type="primary"/>
